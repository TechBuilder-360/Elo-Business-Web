...
import { g as useRouter$1 } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="container max-w-8xl mx-auto px-4"><div class="relative -mt-12 flex items-end gap-4 md:gap-6"><div class="w-24 h-24 md:w-28 md:h-28 rounded-2xl bg-card border-4 border-background shadow-lg flex items-center justify-center shrink-0 overflow-hidden">`);
      {
      ...
      _push(`<!--]--></div><span class="text-xs text-muted-foreground">${ssrInterpolate(avgRating.value)} (${ssrInterpolate(totalReviews.value)}) </span></div></div></div></div></div></div><div class="container max-w-8xl mx-auto px-4 mt-4">`);
      ...
      _push(`</div><main class="container max-w-8xl mx-auto px-4 py-6 space-y-8"><section><h2 class="text-lg font-semibold text-foreground mb-3">About</h2>`);
      ...
      _push(`<!--]--></div></section></main><footer class="border-t bg-card mt-12"><div class="container max-w-8xl mx-auto px-4 py-6 text-center"><p class="text-xs text-muted-foreground"> © ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} ${ssrInterpolate(business.name)}. All rights reserved. </p></div></footer></div>`);
    };
  }
};
...
//# sourceMappingURL=business-CLtVpNst.mjs.map
