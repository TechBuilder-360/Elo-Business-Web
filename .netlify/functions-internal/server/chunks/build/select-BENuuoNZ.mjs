import { ref, computed, provide, h, inject } from 'vue';

const SelectContext = /* @__PURE__ */ Symbol("SelectContext");
const Select = {
  name: "Select",
  props: {
    ...
    return () => h(
      "div",
      {
        ...
        class: [
          ...
          isSelected.value && "bg-accent text-accent-foreground font-semibold",
          props.class
        ]
      },
      slots.default?.()
...
export { Select as S, SelectContent as a, SelectItem as b, SelectTrigger as c, SelectValue as d };
//# sourceMappingURL=select-BENuuoNZ.mjs.map
