import { computed, ref, mergeProps, unref, withCtx, createVNode, openBlock, createBlock, createTextVNode, toDisplayString, Fragment, renderList, withDirectives, createCommentVNode, vModelSelect, h, useSSRContext } from 'vue';
...
import { ArrowLeft, Wallet, Moon, Sun, EyeOff, Eye, ArrowDownLeft, ArrowUpRight, TrendingUp, ChevronRight, Landmark, Check, Copy } from 'lucide-vue-next';
                ...
                if (_push3) {
                  ...
                  ssrRenderList(__props.accounts, (account) => {
                    ...
                    if (__props.isFiat) {
                      ...
                      _push3(ssrRenderComponent(unref(Wallet), { class: "w-4 h-4 text-primary" }, null, _parent3, _scopeId2));
                    }
                    _push3(`</div><span class="text-sm font-semibold text-foreground"${_scopeId2}>${ssrInterpolate(__props.isFiat ? account.bankName : account.network + " Network")}</span></div>`);
                    ...
                    _push3(`</div>`);
                    if (__props.isFiat) {
                      _push3(`<div class="grid grid-cols-1 sm:grid-cols-2 gap-3"${_scopeId2}><div class="flex items-center justify-between gap-2"${_scopeId2}><div${_scopeId2}><p class="text-[11px] text-muted-foreground"${_scopeId2}>Account Name</p><p class="text-sm font-medium font-mono tabular-nums text-foreground"${_scopeId2}>${ssrInterpolate(account.accountName)}</p></div></div><div class="flex items-center justify-between gap-2"${_scopeId2}><div${_scopeId2}><p class="text-[11px] text-muted-foreground"${_scopeId2}>Account Number</p><p class="text-sm font-medium font-mono tabular-nums text-foreground"${_scopeId2}>${ssrInterpolate(account.accountNumber)}</p></div>`);
                      ...
                      _push3(`<div class="grid grid-cols-1 gap-3"${_scopeId2}><div class="flex items-center justify-between gap-2"${_scopeId2}><div class="flex-1 overflow-hidden pr-4"${_scopeId2}><p class="text-[11px] text-muted-foreground"${_scopeId2}>Wallet Address</p><p class="text-sm font-medium font-mono text-foreground truncate"${_scopeId2}>${ssrInterpolate(account.address)}</p></div>`);
                      _push3(ssrRenderComponent(unref(Button), {
                        variant: "ghost",
                        size: "icon",
                        class: "h-6 w-6 shrink-0 text-foreground",
                        onClick: ($event) => handleCopy(account.address, account.id + "-addr")
                      }, {
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            if (copiedId.value === account.id + "-addr") {
                              _push4(ssrRenderComponent(unref(Check), { class: "w-3 h-3 text-emerald-600" }, null, _parent4, _scopeId3));
                            } else {
                              _push4(ssrRenderComponent(unref(Copy), { class: "w-3 h-3 text-muted-foreground" }, null, _parent4, _scopeId3));
                            }
                            ...
                            return [
                              copiedId.value === account.id + "-addr" ? (openBlock(), createBlock(unref(Check), {
                                key: 0,
                                class: "w-3 h-3 text-emerald-600"
                              })) : (openBlock(), createBlock(unref(Copy), {
                                key: 1,
                  ...
                  _push3(ssrRenderComponent(unref(Button), {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<span class="text-lg leading-none mr-2"${_scopeId3}>+</span> ${ssrInterpolate(__props.isFiat ? "Add Bank Account" : "Add Wallet Address")}`);
                      } else {
                        return [
                          createVNode("span", { class: "text-lg leading-none mr-2" }, "+"),
                          createTextVNode(" " + toDisplayString(__props.isFiat ? "Add Bank Account" : "Add Wallet Address"), 1)
                        ];
                      }
                    }),
                    _: 1
                  ...
                  return [
                    (openBlock(true), createBlock(Fragment, null, renderList(__props.accounts, (account) => {
                      return openBlock(), createBlock("div", {
                        ...
                        createVNode("div", { class: "flex items-center justify-between" }, [
                          createVNode("div", { class: "flex items-center gap-2" }, [
                            createVNode("div", { class: "w-8 h-8 rounded-md bg-primary/10 flex items-center justify-center" }, [
                              __props.isFiat ? (openBlock(), createBlock(unref(Landmark), {
                                key: 0,
                                class: "w-4 h-4 text-primary"
                              })) : (openBlock(), createBlock(unref(Wallet), {
                                key: 1,
                                class: "w-4 h-4 text-primary"
                              }))
                            ]),
                            createVNode("span", { class: "text-sm font-semibold text-foreground" }, toDisplayString(__props.isFiat ? account.bankName : account.network + " Network"), 1)
                          ]),
                        ...
                        __props.isFiat ? (openBlock(), createBlock("div", {
                          key: 0,
                          ...
                          createVNode("div", { class: "flex items-center justify-between gap-2" }, [
                            createVNode("div", { class: "flex-1 overflow-hidden pr-4" }, [
                              createVNode("p", { class: "text-[11px] text-muted-foreground" }, "Wallet Address"),
                              createVNode("p", { class: "text-sm font-medium font-mono text-foreground truncate" }, toDisplayString(account.address), 1)
                            ]),
                            createVNode(unref(Button), {
                              variant: "ghost",
                              size: "icon",
  ...
  setup(__props) {
    ...
    const wallets = computed(() => {
      ...
      return fetchedWallets.map((w) => {
        ...
        const is_fiat = curr.is_fiat !== void 0 ? curr.is_fiat : true;
        const mockAccounts = [];
        if (is_fiat) {
          if (w.currency === "NGN") {
            mockAccounts.push(
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div><h1 class="text-lg font-bold leading-tight">Wallet</h1><p class="text-xs text-muted-foreground">${ssrInterpolate(businessName.value)}</p></div></div>`);
      _push(ssrRenderComponent(unref(Button), {
        variant: "ghost",
        size: "icon",
      ...
      if (selectedWallet.value) {
        ...
        _push(ssrRenderComponent(_sfc_main$1, {
          ...
          isFiat: selectedWallet.value.is_fiat
        }, null, _parent));
        _push(ssrRenderComponent(unref(Card), { class: "border-0 shadow-md shadow-foreground/5 bg-card" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
                ...
                _push3(ssrRenderComponent(unref(CardContent), { class: "space-y-4" }, {
                  default: withCtx((_2, _push4, _parent3, _scopeId2) => {
                    if (_push4) {
                      ...
                      if (groupedCurrencies.value.fiat?.length) {
                        _push4(`<optgroup label="Fiat Currencies"${_scopeId2}><!--[-->`);
                        ssrRenderList(groupedCurrencies.value.fiat, (c) => {
                      ...
                      if (groupedCurrencies.value.crypto?.length) {
                        _push4(`<optgroup label="Crypto Currencies"${_scopeId2}><!--[-->`);
                        ssrRenderList(groupedCurrencies.value.crypto, (c) => {
                          _push4(`<option${ssrRenderAttr("value", c.code)}${ssrIncludeBooleanAttr(Array.isArray(selectedCurrencyCode.value) ? ssrLooseContain(selectedCurrencyCode.value, c.code) : ssrLooseEqual(selectedCurrencyCode.value, c.code)) ? " selected" : ""}${_scopeId2}>${ssrInterpolate(c.symbol)} ${ssrInterpolate(c.name)} (${ssrInterpolate(c.code)}) </option>`);
                        });
                        _push4(`<!--]--></optgroup>`);
                      } else {
                      ...
                      return [
                        createVNode("div", { class: "space-y-2" }, [
                          ...
                          withDirectives(createVNode("select", {
                            ...
                            groupedCurrencies.value.fiat?.length ? (openBlock(), createBlock("optgroup", {
                              key: 0,
                              label: "Fiat Currencies"
                            }, [
                              (openBlock(true), createBlock(Fragment, null, renderList(groupedCurrencies.value.fiat, (c) => {
                            ...
                            groupedCurrencies.value.crypto?.length ? (openBlock(), createBlock("optgroup", {
                              key: 1,
                              label: "Crypto Currencies"
                            }, [
                              (openBlock(true), createBlock(Fragment, null, renderList(groupedCurrencies.value.crypto, (c) => {
                                return openBlock(), createBlock("option", {
                                  key: c.code,
                                  value: c.code
                                }, toDisplayString(c.symbol) + " " + toDisplayString(c.name) + " (" + toDisplayString(c.code) + ") ", 9, ["value"]);
...
//# sourceMappingURL=wallet-CUw0Ka-0.mjs.map
