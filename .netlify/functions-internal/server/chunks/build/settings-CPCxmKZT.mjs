import { computed, mergeProps, unref, withCtx, createVNode, openBlock, createBlock, createTextVNode, ref, toDisplayString, h, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrInterpolate, ssrRenderList } from 'vue/server-renderer';
import { T as Tabs, b as TabsList, c as TabsTrigger, a as TabsContent } from './tabs-1FqyMY98.mjs';
import { ArrowLeft, Moon, Sun, Info, Users, ChevronRight, Lock, UserPlus, Shield, Trash2 } from 'lucide-vue-next';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="w-10 h-10 rounded-lg bg-primary flex items-center justify-center overflow-hidden"><img${ssrRenderAttr("src", "/favicon_io/favicon_io/apple-touch-icon.png")} class="w-full h-full object-cover" alt="ELO"></div><div><h1 class="text-lg font-bold leading-tight">Settings</h1><p class="text-xs text-muted-foreground">${ssrInterpolate(businessName.value)}</p></div></div>`);
      _push(ssrRenderComponent(unref(Button), {
        variant: "ghost",
        size: "icon",
...
//# sourceMappingURL=settings-CPCxmKZT.mjs.map
