import { ref, provide, h, inject, computed } from 'vue';

const TabsContext = /* @__PURE__ */ Symbol("TabsContext");
const Tabs = {
  name: "Tabs",
  props: {
    defaultValue: String,
    ...
    return () => h(
      "button",
      {
        ...
        class: [
          ...
          isActive.value ? "bg-background text-foreground shadow font-semibold" : "text-muted-foreground hover:bg-muted/50",
          props.class
        ]
      },
      slots.default?.()
...
//# sourceMappingURL=tabs-1FqyMY98.mjs.map
